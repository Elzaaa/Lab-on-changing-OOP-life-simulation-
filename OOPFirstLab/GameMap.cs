...
namespace OOPFirstLab
{
    ...
    public class GameMap : IGameMap
    {
        ...
        public bool PlaceGameObjectNearPositionAtFreeCell(IGameObject @object, Position position)
        {
            ...
            MoveDirection[] shuffleMoveDirections = (MoveDirection[])System.Enum.GetValues(typeof(MoveDirection));
            ShuffleArray(shuffleMoveDirections);

            foreach (MoveDirection moveDirection in shuffleMoveDirections)
            {
                Position newPos = position.GetNeaghborPosition(moveDirection);

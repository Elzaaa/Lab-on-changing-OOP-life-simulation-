...
namespace OOPFirstLab.GameObjects
{
    ...
    {
        protected readonly GameObjectDescriptor _objectDescriptor;
        protected readonly IGameEngine _gameEngine;

        protected GameObject(IGameEngine gameEngine, GameObjectType type, string xmlDescriptor)
        {
            _objectDescriptor = new GameObjectDescriptor(type, xmlDescriptor);
        ...
        public bool IsMutant { get; protected set; } = false;
        ...
        public virtual bool MakeMove()
        {
            ...
            else if (_objectDescriptor.CanJump)
            {
                // реализуем логику прыжка
            }
        ...
        /// </summary>
        public virtual GameObject Pair { get; set; } = null;
        ...
        protected void CreatePair()
        {
            ...
            if (_objectDescriptor.HasGender && Pair == null && Gender != Gender.Unspecified)
            {
                ...
                {
                    bool result = false;
                    if (gameObject.Type == Type && Type != GameObjectType.Undefined)
                    {
                        result = gameObject is GameObject go
                ...
                if (pair != null && pair is GameObject goodPair)
                {
                    goodPair.Pair = this;
                    Pair = goodPair;
                }
